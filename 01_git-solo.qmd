...
Si seguiste las instrucciones [instrucciones previas al curso](A_instalacion.html) deberías tener todo listo, pero podemos revisar el estado de situación con `usethis::git_sitrep()` para comprobarlo.
...
Si vez alguna diferencia, es útil revisar las instrucciones de instalación en "" TODO: agregar link y titulo.
